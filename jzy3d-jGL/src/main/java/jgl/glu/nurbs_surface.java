...
public class nurbs_surface extends nurbs_nurbs {
  ...
  public void fill(int sknot_count, float sknot[], int tknot_count, float tknot[], int s_stride, int t_stride,
      float surctrlarray[][][], int sorder, int torder, int surtype) {
