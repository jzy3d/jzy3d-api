...
public class GLJ3DGeometry {
  ...
  /**
   * Draws a color cube with the specified scale. The corners of the color cube
   * are [-scale,-scale,-scale] and [scale,scale,scale].
   * 
   * @param JavaGL the JavaGL instance
   * @param scale  the scale of the cube
   */
  public static final void drawColorCube(GL JavaGL, double scale) {
    int faces[][] = { { 5, 6, 2, 1 }, { 7, 4, 0, 3 }, { 7, 6, 5, 4 }, { 0, 1, 2, 3 }, { 3, 2, 6, 7 }, { 4, 5, 1, 0 }, };
