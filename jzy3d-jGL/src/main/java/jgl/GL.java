...
public class GL {
  ...
  /** the following functions are only for developpers **/
	...
	/**
	 *
	 * Data types Because Java is architecture IN-dependent use the original data
...
//	    case GL_AUTO_NORMAL:
		...
		case GL_LOGIC_OP:
			 ...
			 * GL_MAP1_TEXTURE_COORD_1: case GL_MAP1_TEXTURE_COORD_2: case
			 * GL_MAP1_TEXTURE_COORD_3: case GL_MAP1_TEXTURE_COORD_4: case GL_MAP1_VERTEX_3:
			 * case GL_MAP1_VERTEX_4: case GL_MAP2_COLOR_4: case GL_MAP2_INDEX: case
			 * GL_MAP2_NORMAL: case GL_MAP2_TEXTURE_COORD_1: case GL_MAP2_TEXTURE_COORD_2:
			 * case GL_MAP2_TEXTURE_COORD_3: case GL_MAP2_TEXTURE_COORD_4: case
			 * GL_MAP2_VERTEX_3: case GL_MAP2_VERTEX_4:
			 */
		case GL_NORMALIZE:
	...
	private int translate_id(int n, int type, byte lists[]) {
		...
		case GL_UNSIGNED_INT:
		case GL_4_BYTES:
			return (int) ((lists[n << 2]) << 24 | (lists[(n << 2) | 1]) << 16 | (lists[(n << 2) | 2]) << 8
					| (lists[(n << 2) | 3]));
		case GL_FLOAT:
	 ...
	 */
	/*
	 * GLvoid glClearColor (GLclampf red, GLclampf green, GLclampf blue, GLclampf
	 * alpha)
	 */
	 ...
	 * <i>mask</i> argument is the bitwise-ORed combination of a number of values
	 * indicating which buffers are to be cleared. The values are
...
//	    CC.gl_clear_accum_buffer ();
	...
	/**
	 * GLvoid glColorMask (GLboolean red, GLboolean green, GLboolean blue, GLboolean
	 * alpha )
	 */
	...
	/**
	 * Sets the current stippling patterm for lines. The <i>pattern</i> argument is
	 * a 16-bit series of 0s and 1s, and it's repeated as necessary to stipple a
	 * given line. A 1 indicates that drawing occurs, and 0 that it does not, on a
	 * pixel-by-pixel basis, beginning with the low-order bits of the pattern. The
	 * pattern can be stretched out by using <i>factor</i>, which multiplies each
	...
	/**
	 * Defines the current stipple pattern for filled polygons. The argument
	 * <i>mask</i> is a 32x32 bitmap that's interpreted as a mask of 0s and 1s.
	 * Where a 1 appears, the corresponding pixel in the polygon is drawn, and where
	 * a 0 appears, nothing is drawn.
	 * 
	...
	/**
	 * Sets the window <i>z</i> value. The <i>depth</i> is a floating point value
	 * that is clamped to the range [0,1] and converted to fixed-point.
	 * 
	...
	/**
	 * GLvoid glFrustum (GLdouble left, GLdouble right, GLdouble bottom, GLdouble
	 * top, GLdouble near_val, GLdouble far_val)
	 */
...
//	    CC = new gl_list ();
	...
	public void glColor3i(int red, int green, int blue) {
		CC.gl_color(gl_util.ItoF(gl_util.CLAMP(red, 0, 255)), gl_util.ItoF(gl_util.CLAMP(green, 0, 255)),
				gl_util.ItoF(gl_util.CLAMP(blue, 0, 255)), 1.0f);
	}
	...
	/**
	 * GLvoid glColor4d (GLdouble red, GLdouble green, GLdouble blue, GLdouble
	 * alpha)
	 */
	...
	public void glColor4i(int red, int green, int blue, int alpha) {
		CC.gl_color(gl_util.ItoF(gl_util.CLAMP(red, 0, 255)), gl_util.ItoF(gl_util.CLAMP(green, 0, 255)),
				gl_util.ItoF(gl_util.CLAMP(blue, 0, 255)), gl_util.ItoF(gl_util.CLAMP(alpha, 0, 255)));
	}
	...
	/**
	 * GLvoid glColor4us (GLushort red, GLushort green, GLushort blue, GLushort
	 * alpha)
	 */
	...
	/**
	 * GLvoid glReadPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum
	...
	/**
	 * GLvoid glDrawPixels (GLsizei width, GLsizei height, GLenum format, GLenum
	...
	/**
	 * GLvoid glCopyPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum
	 * type)
	 */
	...
	/**
	 * GLvoid glTexImage1D (GLenum target, GLint level, GLint components, GLsizei
	...
	/**
	 * GLvoid glTexImage2D (GLenum target, GLint level, GLint components, GLsizei
...
//			      int format, int type, byte pixels [][][]) {
	...
	/**
	 * GLvoid glTexImage3D (GLenum target, GLint level, GLint components, GLsizei
	...
	/**
	 * GLvoid glGetTexImage (GLenum target, GLint level, GLenum format, GLenum type,
	 * GLvoid *pixels)
	 */
	...
	/**
	 * GLvoid glPrioritizeTextures (GLsizei n, const GLuint *textures, const
	 * GLclampf *priorities)
	 */
	...
	/**
	 * GLvoid glTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei
	...
	/**
	 * GLvoid glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint
	...
	/**
	 * GLvoid glTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint
	...
	public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height,
		...
		CC.gl_tex_sub_image_3d(target, level, xoffset + b, yoffset + b, zoffset + b, width + xoffset + b,
				height + yoffset + b, depth + zoffset + b, format, size, pixels);
	}
	...
	/**
	 * GLvoid glCopyTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLint
	...
	/**
	 * GLvoid glCopyTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint
	...
	/**
	 * GLvoid glCopyTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint
	...
	/**
	 * GLvoid glMap1d (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint
...
//	    CC.gl_map_1 (target, (float)u1, (float)u2, stride, order, np);
	...
	/**
	 * GLvoid glMap1f (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint
...
//		dim = CC.gl_map_1 (target, u1, u2, stride, order, points);
	...
	/**
	 * GLvoid glMap2d (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint
...
//	    CC.gl_map_2 (target, (float)u1, (float)u2, ustride, uorder,
	...
	/**
	 * GLvoid glMap2f (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint
...
//	CC.gl_map_grid_1 (un, u1, u2);
	...
	/**
	 * GLvoid glMapGrid2d (GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble
	 * v1, GLdouble v2)
	 */
...
//	CC.gl_map_grid_2 (un, (float)u1, (float)u2, 
	...
	/**
	 * GLvoid glMapGrid2f (GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1,
	 * GLfloat v2)
	 */
...
//	CC.gl_eval_point_2 (i, j);
	...
	/**
	 * GLX Functions Java is not X-Window system, the following functions are just
