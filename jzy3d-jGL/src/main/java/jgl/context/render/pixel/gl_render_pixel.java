...
//	put_pixel (x, y, z, CC.Texture.tex_vertex (s, t));
	...
	public void put_pixel_by_index(int index, float w, float s, float t, float r, float dsdx, float dsdy, float dtdx,
...
//	put_pixel (x, y, CC.Texture.tex_vertex (s, t, w, dsdx, dsdy, dtdx, dtdy));
	...
	public void put_pixel_by_index(int index, float z, float w, float s, float t, float r, float dsdx, float dsdy,
...
//	put_pixel (x, y, z, CC.Texture.tex_vertex (s, t, w, dsdx,dsdy,dtdx,dtdy));
	...
	public void put_pixel_by_index(int index, float w, float s, float t, float r, float dsdx, float dsdy, float dtdx,
			float dtdy, float drdx, float drdy, int c) {
