...
/**
 * gl_lit_tex_z is the rendering class for texturing with lighting and depth of
 * jGL 2.3.
 *
...
public class gl_lit_tex_z extends gl_lit_tex {
   ...
   */
  private void draw_horizontal_line(int x1, int rgb1[], int x2, int rgb2[], int y, float z1, float w1, float s1,
      float t1, float r1) {
    this.LineZ[0] = z1;
  ...
  protected void draw_horizontal_line(int y) {
    draw_horizontal_line(LeftPoint, LeftPointRGB, RightPoint, RightPointRGB, y, LeftPointZ, LeftPointW, LeftPointS,
        LeftPointT, LeftPointR);
  }
