...
public class gl_current {
  ...
  /**
   * GL_CURRENT_RASTER_TEXTURE_COORDS: Texture coordinates associated with raster
   * position
   */
...
//				((int)(b * (float)255.0));
   ...
   * boolean [ 2]; AttribItem.IntPtr = new int [ 2]; AttribItem.FloatPtr = new
   * float [25];
   * 
   * System.arraycopy(Color, 0, AttribItem.FloatPtr, 0, 4); AttribItem.IntPtr [ 0]
   * = IntColor; AttribItem.IntPtr [ 1] = Index; System.arraycopy(TexCoord, 0,
   * AttribItem.FloatPtr, 4, 4); System.arraycopy(Normal, 0, AttribItem.FloatPtr,
   * 8, 3); System.arraycopy(RasterPos, 0, AttribItem.FloatPtr, 11, 4);
   * AttribItem.FloatPtr [15] = RasterDistance; System.arraycopy(RasterColor, 0,
   * AttribItem.FloatPtr, 16, 4); AttribItem.FloatPtr [20] = RasterIndex;
   ...
   * System.arraycopy(AttribItem.FloatPtr, 0, Color, 0, 4); IntColor =
   * AttribItem.IntPtr [ 0]; Index = AttribItem.IntPtr [ 1];
   * System.arraycopy(AttribItem.FloatPtr, 4, TexCoord, 0, 4);
   * System.arraycopy(AttribItem.FloatPtr, 8, Normal, 0, 3);
   * System.arraycopy(AttribItem.FloatPtr, 11, RasterPos, 0, 4); RasterDistance =
   * AttribItem.FloatPtr [15]; System.arraycopy(AttribItem.FloatPtr, 16,
   * RasterColor, 0, 4); RasterIndex = AttribItem.FloatPtr [20];
   * System.arraycopy(AttribItem.FloatPtr, 21, RasterTexCoord, 0, 4);
   * RasterPosValid = AttribItem.BoolPtr [ 0]; EdgeFlag = AttribItem.BoolPtr [ 1];
   * }
   */
