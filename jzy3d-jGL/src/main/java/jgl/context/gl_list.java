...
//    private static final int NODE_DRAW_PIXELS		= 31;
  ...
  /*
   * private static final int NODE_EVAL_COORD_1 = 33; private static final int
   * NODE_EVAL_COORD_2 = 34; private static final int NODE_EVAL_MESH_1 = 35;
   * private static final int NODE_EVAL_MESH_2 = 36; private static final int
   * NODE_EVAL_POINT_1 = 37; private static final int NODE_EVAL_POINT_2 = 38;
   */
  ...
  /*
   * private static final int NODE_MAP_1 = 53; private static final int NODE_MAP_2
   * = 54; private static final int NODE_MAP_GRID_1 = 55; private static final int
   * NODE_MAP_GRID_2 = 56;
   */
  ...
  public void gl_exec_list(gl_context CC) {
    ...
    for (i = 0; i < ThisList.size(); i++) {
      ...
      case NODE_CLEAR_COLOR:
        CC.gl_clear_color(ListItem.FloatPtr[0], ListItem.FloatPtr[1], ListItem.FloatPtr[2], ListItem.FloatPtr[3]);
        break;
       ...
       * (float[][])ListItem.ObjPtr); break; case NODE_MAP_2: CC.gl_map_2
       * (ListItem.IntPtr[0], ListItem.FloatPtr[0], ListItem.FloatPtr[1],
       * ListItem.IntPtr[1], ListItem.IntPtr[2], ListItem.FloatPtr[2],
       * ListItem.FloatPtr[3], ListItem.IntPtr[3], ListItem.IntPtr[4],
       * (float[][][])ListItem.ObjPtr); break; case NODE_EVAL_COORD_1:
       * CC.gl_eval_coord_1 (ListItem.FloatPtr[0]); break; case NODE_EVAL_COORD_2:
       * CC.gl_eval_coord_2 (ListItem.FloatPtr[0], ListItem.FloatPtr[1]); break; case
       * NODE_MAP_GRID_1: CC.gl_map_grid_1 (ListItem.IntPtr[0], ListItem.FloatPtr[0],
       * ListItem.FloatPtr[1]); break; case NODE_MAP_GRID_2: CC.gl_map_grid_2
       * (ListItem.IntPtr[0], ListItem.FloatPtr[0], ListItem.FloatPtr[1],
       * ListItem.IntPtr[1], ListItem.FloatPtr[2], ListItem.FloatPtr[3]); break; case
       * NODE_EVAL_POINT_1: CC.gl_eval_point_1 (ListItem.IntPtr[0]); break; case
       * NODE_EVAL_POINT_2: CC.gl_eval_point_2 (ListItem.IntPtr[0],
       * ListItem.IntPtr[1]); break; case NODE_EVAL_MESH_1: CC.gl_eval_mesh_1
       * (ListItem.IntPtr[0], ListItem.IntPtr[1], ListItem.IntPtr[2]); break; case
       * NODE_EVAL_MESH_2: CC.gl_eval_mesh_2 (ListItem.IntPtr[0], ListItem.IntPtr[1],
       * ListItem.IntPtr[2], ListItem.IntPtr[3], ListItem.IntPtr[4]); break;
       */
      case NODE_RASTER_POS:
        CC.gl_raster_pos(ListItem.FloatPtr[0], ListItem.FloatPtr[1], ListItem.FloatPtr[2], ListItem.FloatPtr[3]);
        break;
      ...
      case NODE_COPY_STENCIL_PIXELS:
        CC.gl_copy_stencil_pixels(ListItem.IntPtr[0], ListItem.IntPtr[1], ListItem.IntPtr[2], ListItem.IntPtr[3]);
        break;
      ...
      case NODE_TEX_IMAGE_2D:
        CC.gl_tex_image_2d(ListItem.IntPtr[0], ListItem.IntPtr[1], ListItem.IntPtr[2], ListItem.IntPtr[3],
            ListItem.IntPtr[4], ListItem.IntPtr[5], ListItem.IntPtr[6], ListItem.IntPtr[7], ListItem.ObjPtr);
        break;
      case NODE_TEX_IMAGE_3D:
        CC.gl_tex_image_3d(ListItem.IntPtr[0], ListItem.IntPtr[1], ListItem.IntPtr[2], ListItem.IntPtr[3],
            ListItem.IntPtr[4], ListItem.IntPtr[5], ListItem.IntPtr[6], ListItem.IntPtr[7], ListItem.IntPtr[8],
            ListItem.ObjPtr);
        break;
      ...
      case NODE_TEX_SUB_IMAGE_2D:
        CC.gl_tex_sub_image_2d(ListItem.IntPtr[0], ListItem.IntPtr[1], ListItem.IntPtr[2], ListItem.IntPtr[3],
            ListItem.IntPtr[4], ListItem.IntPtr[5], ListItem.IntPtr[6], ListItem.IntPtr[7], ListItem.ObjPtr);
        break;
      case NODE_TEX_SUB_IMAGE_3D:
        CC.gl_tex_sub_image_3d(ListItem.IntPtr[0], ListItem.IntPtr[1], ListItem.IntPtr[2], ListItem.IntPtr[3],
            ListItem.IntPtr[4], ListItem.IntPtr[5], ListItem.IntPtr[6], ListItem.IntPtr[7], ListItem.IntPtr[8],
            ListItem.IntPtr[9], ListItem.ObjPtr);
        break;
...
//				 int format, int type, byte pixels [][][]) {
  ...
  public void gl_tex_sub_image_3d(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height,
      int depth, int format, int size, Object pixels) {
    ...
    ThisList.addElement(ListItem);
    if (ExecuteFlag) {
      Context.gl_tex_sub_image_3d(target, level, xoffset, yoffset, zoffset, width, height, depth, format, size, pixels);
    }
  }

  /*
   * public int gl_map_1 (int target, float u1, float u2, int stride, int order,
   * float points [][]) { ListItem = new gl_list_item (NODE_MAP_1);
   * ListItem.IntPtr = new int [3]; ListItem.IntPtr [0] = target; ListItem.IntPtr
   * [1] = stride; ListItem.IntPtr [2] = order; ListItem.FloatPtr = new float [2];
   * ListItem.FloatPtr [0] = u1; ListItem.FloatPtr [1] = u2;
   * 
   * int i, j, dim; switch (target) { case GL.GL_MAP1_VERTEX_3: dim = 3; break;
   * case GL.GL_MAP1_VERTEX_4: dim = 4; break; case GL.GL_MAP1_INDEX: dim = 1;
   * break; case GL.GL_MAP1_COLOR_4: dim = 4; break; case GL.GL_MAP1_NORMAL: dim =
   * 3; break; case GL.GL_MAP1_TEXTURE_COORD_1: dim = 1; break; case
   * GL.GL_MAP1_TEXTURE_COORD_2: dim = 2; break; case GL.GL_MAP1_TEXTURE_COORD_3:
   * dim = 3; break; case GL.GL_MAP1_TEXTURE_COORD_4: dim = 4; break; default: dim
   * = 0; }
   * 
   * float temp [][] = new float [order][dim]; for (i = 0; i < order; i++) for (j
   * = 0; j < dim; j++) temp[i][j] = points[i][j];
   * 
   * ListItem.ObjPtr = (Object)temp; ThisList.addElement (ListItem); if
   * (ExecuteFlag) { Context.gl_map_1 (target, u1, u2, stride, order, points); }
   * return dim; }
   * 
   * public int gl_map_2 (int target, float u1, float u2, int ustride, int uorder,
   * float v1, float v2, int vstride, int vorder, float points [][][]) { ListItem
   * = new gl_list_item (NODE_MAP_2); ListItem.IntPtr = new int [5];
   * ListItem.IntPtr [0] = target; ListItem.IntPtr [1] = ustride; ListItem.IntPtr
   * [2] = uorder; ListItem.IntPtr [3] = vstride; ListItem.IntPtr [4] = vorder;
   * ListItem.FloatPtr = new float [4]; ListItem.FloatPtr [0] = u1;
   * ListItem.FloatPtr [1] = u2; ListItem.FloatPtr [2] = v1; ListItem.FloatPtr [3]
   * = v2;
   * 
   * int i, j, k, dim; switch (target) { case GL.GL_MAP2_VERTEX_3: dim = 3; break;
   * case GL.GL_MAP2_VERTEX_4: dim = 4; break; case GL.GL_MAP2_INDEX: dim = 1;
   * break; case GL.GL_MAP2_COLOR_4: dim = 4; break; case GL.GL_MAP2_NORMAL: dim =
   * 3; break; case GL.GL_MAP2_TEXTURE_COORD_1: dim = 1; break; case
   * GL.GL_MAP2_TEXTURE_COORD_2: dim = 2; break; case GL.GL_MAP2_TEXTURE_COORD_3:
   * dim = 3; break; case GL.GL_MAP2_TEXTURE_COORD_4: dim = 4; break; default: dim
   * = 0; }
   * 
   * float temp [][][] = new float [uorder][vorder][dim]; for (i = 0; i < uorder;
   * i++) for (j = 0; j < vorder; j++) for (k = 0; k < dim; k++) temp[i][j][k] =
   * points[i][j][k];
   * 
   * ListItem.ObjPtr = (Object)temp; ThisList.addElement (ListItem); if
   * (ExecuteFlag) { Context.gl_map_2 (target, u1, u2, ustride, uorder, v1, v2,
   * vstride, vorder, points); } return dim; }
   * 
   * public void gl_eval_coord_1 (float u) { ListItem = new gl_list_item
   * (NODE_EVAL_COORD_1); ListItem.FloatPtr = new float [1]; ListItem.FloatPtr [0]
   * = u; ThisList.addElement (ListItem); if (ExecuteFlag) {
   * Context.gl_eval_coord_1 (u); } }
   * 
   * public void gl_eval_coord_2 (float u, float v) { ListItem = new gl_list_item
   * (NODE_EVAL_COORD_2); ListItem.FloatPtr = new float [2]; ListItem.FloatPtr [0]
   * = u; ListItem.FloatPtr [1] = v; ThisList.addElement (ListItem); if
   * (ExecuteFlag) { Context.gl_eval_coord_2 (u, v); } }
   * 
   * public void gl_map_grid_1 (int un, float u1, float u2) { ListItem = new
   * gl_list_item (NODE_MAP_GRID_1); ListItem.IntPtr = new int [1];
   * ListItem.IntPtr [0] = un; ListItem.FloatPtr = new float [2];
   * ListItem.FloatPtr [0] = u1; ListItem.FloatPtr [1] = u2; ThisList.addElement
   * (ListItem); if (ExecuteFlag) { Context.gl_map_grid_1 (un, u1, u2); } }
   * 
   * public void gl_map_grid_2 (int un, float u1, float u2, int vn, float v1,
   * float v2) { ListItem = new gl_list_item (NODE_MAP_GRID_2); ListItem.IntPtr =
   * new int [2]; ListItem.IntPtr [0] = un; ListItem.IntPtr [1] = vn;
   * ListItem.FloatPtr = new float [4]; ListItem.FloatPtr [0] = u1;
   * ListItem.FloatPtr [1] = u2; ListItem.FloatPtr [2] = v1; ListItem.FloatPtr [3]
   * = v2; ThisList.addElement (ListItem); if (ExecuteFlag) {
   * Context.gl_map_grid_2 (un, u1, u2, vn, v1, v2); } }
   * 
   * public void gl_eval_point_1 (int i) { ListItem = new gl_list_item
   * (NODE_EVAL_POINT_1); ListItem.IntPtr = new int [1]; ListItem.IntPtr [0] = i;
   * ThisList.addElement (ListItem); if (ExecuteFlag) { Context.gl_eval_point_1
   * (i); } }
   * 
   * public void gl_eval_point_2 (int i, int j) { ListItem = new gl_list_item
   * (NODE_EVAL_POINT_2); ListItem.IntPtr = new int [2]; ListItem.IntPtr [0] = i;
   * ListItem.IntPtr [1] = j; ThisList.addElement (ListItem); if (ExecuteFlag) {
   * Context.gl_eval_point_2 (i, j); } }
   * 
   * public void gl_eval_mesh_1 (int mode, int nu1, int nu2) { ListItem = new
   * gl_list_item (NODE_EVAL_MESH_1); ListItem.IntPtr = new int [3];
   * ListItem.IntPtr [0] = mode; ListItem.IntPtr [1] = nu1; ListItem.IntPtr [2] =
   * nu2; ThisList.addElement (ListItem); if (ExecuteFlag) {
   * Context.gl_eval_mesh_1 (mode, nu1, nu2); } }
   * 
   * public void gl_eval_mesh_2 (int mode, int nu1, int nu2, int nv1, int nv2) {
   * ListItem = new gl_list_item (NODE_EVAL_MESH_2); ListItem.IntPtr = new int
   * [5]; ListItem.IntPtr [0] = mode; ListItem.IntPtr [1] = nu1; ListItem.IntPtr
   * [2] = nu2; ListItem.IntPtr [3] = nv1; ListItem.IntPtr [4] = nv2;
   * ThisList.addElement (ListItem); if (ExecuteFlag) { Context.gl_eval_mesh_2
   * (mode, nu1, nu2, nv1, nv2); } }
   */
