...
public abstract class gl_object {
	...
	/*
	 * public abstract void gl_copy_tex_image_1d (int target, int level, int
	 * internalformat, int x, int y, int width, int border); public abstract void
	 * gl_copy_tex_image_2d (int target, int level, int internalformat, int x, int
	 * y, int width, int height, int border); public abstract void
	 * gl_copy_tex_sub_image_1d (int target, int level, int xoffset, int yoffset,
	 * int x, int y, int width); public abstract void gl_copy_tex_sub_image_2d (int
	 * target, int level, int xoffset, int yoffset, int x, int y, int width, int
	 * height); public abstract void gl_copy_tex_sub_image_3d (int target, int
	 * level, int xoffset, int yoffset, int zoffset, int x, int y, int width, int
	 * height);
	 */
