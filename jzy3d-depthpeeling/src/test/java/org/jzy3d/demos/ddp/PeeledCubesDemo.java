...
public class PeeledCubesDemo {
  public static void main(String[] args) throws InterruptedException {
    ...
    // p.setPeelingMethod(PeelingMethod.F2B_PEELING_MODE);

    // GL_INVALID_OPERATION error is generated by glNamedFramebufferDrawBuffer if framebuffer is not
    ...
    // GL_NONE or GL_COLOR_ATTACHMENT$m$, where $m$ is a value between 0 and
