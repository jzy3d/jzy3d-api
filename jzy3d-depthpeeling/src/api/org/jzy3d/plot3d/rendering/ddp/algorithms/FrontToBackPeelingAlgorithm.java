...
public class FrontToBackPeelingAlgorithm extends AbstractDepthPeelingAlgorithm implements IDepthPeelingAlgorithm{
    ...
    protected void buildShaders(GL2 gl) {
        ...
        glslFinal.loadAndCompileFragmentShader(gl, shaderFinal.getFragmentStream(), shaderFinal.getVertexURL());
        glslFinal.link(gl);
    }
    ...
    protected void initFrontPeelingRenderTargets(GL2 gl, int g_imageWidth, int g_imageHeight) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            gl.glTexImage2D(GL2.GL_TEXTURE_RECTANGLE_ARB, 0, GL2.GL_DEPTH_COMPONENT32F, g_imageWidth, g_imageHeight, 0, GL2.GL_DEPTH_COMPONENT, GL2.GL_FLOAT, null);
            ...
            gl.glFramebufferTexture2D(GL2.GL_FRAMEBUFFER, GL2.GL_DEPTH_ATTACHMENT, GL2.GL_TEXTURE_RECTANGLE_ARB, g_frontDepthTexId[i], 0);
            gl.glFramebufferTexture2D(GL2.GL_FRAMEBUFFER, GL2.GL_COLOR_ATTACHMENT0, GL2.GL_TEXTURE_RECTANGLE_ARB, g_frontColorTexId[i], 0);
        }
        ...
        gl.glFramebufferTexture2D(GL2.GL_FRAMEBUFFER, GL2.GL_DEPTH_ATTACHMENT, GL2.GL_TEXTURE_RECTANGLE_ARB, g_frontDepthTexId[0], 0);
        gl.glFramebufferTexture2D(GL2.GL_FRAMEBUFFER, GL2.GL_COLOR_ATTACHMENT0, GL2.GL_TEXTURE_RECTANGLE_ARB, g_frontColorBlenderTexId[0], 0);
    }
