 ...
 * easier transition of existing code. Note that it will be more efficient to 
 * directly implement the corresponding {@link com.jogamp.newt.event.MouseListener}.
 * 
