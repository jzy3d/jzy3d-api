...
public class Graph {
	...
	protected synchronized void draw(GL gl, GLU glu, Camera camera,
			List<AbstractDrawable> components, boolean sort) {
		if (gl.isGL2()) {
	 ...
	 * {@link AbstractDrawable} that has {@link AWTLegend} that must be displayed.
	 */
