...
public class ChartLauncherSwing  extends ChartLauncher {
    ...
    public static void openLightEditors(Chart chart) {
        ...
        // Windows
        ChartLauncherSwing.openPanel(lightEditor, new Rectangle(0,0,200,900), "Light");
        ChartLauncherSwing.openPanel(enlightableEditor, new Rectangle(200,0,200,675), "Material");
    }
