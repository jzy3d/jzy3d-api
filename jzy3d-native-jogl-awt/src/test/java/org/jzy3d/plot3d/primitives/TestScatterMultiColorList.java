...
public class TestScatterMultiColorList {
    ...
    public void testScatterNoSpaceTransform(){
        ...
        // ---------------------------------------------
        // Given
        scatter = new ScatterMultiColorList(coords, new ColorMapper(new ColorMapRainbow(), 0.1, 1.1, new Color(1, 1, 1, .5f)));
        testScatter(coords, scatter); 

        
        // ---------------------------------------------
        // Given
        scatter = new ConcurrentScatterMultiColorList(coords, new ColorMapper(new ColorMapRainbow(), 0.1, 1.1, new Color(1, 1, 1, .5f)));
        testScatter(coords, scatter); 
    }
