...
public class TestVBOBufferLoaderForArray {
  ...
  public void givenGivenVerticeOnly_WhenLoading_ThenSimpleNormalAreComputed() throws InterruptedException {
    ...
    // When
    //VBOBufferLoaderForArrays loader = new VBOBufferLoaderForArrays(vertices, dimensions, null, 3, null,
     //   null, NormalMode.PER_VERTEX);
