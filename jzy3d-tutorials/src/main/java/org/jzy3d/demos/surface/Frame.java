...
public class Frame {
	...
	public static void print(Chart chart, FrameAWT frame, String file) throws IOException {
    	...
    	// TODO : move setupPrint/releasePrint to ICanvas to avoid casting to GLCAnvas and then allow move
    	// this method to FrameAWT (which is in a package not seeing JOGL)
		GLCanvas canvas = (GLCanvas)chart.getCanvas();
    	// custom multisampling value: < 0 turns off, == 0 leaves as-is, > 0 enables using given num samples
    	int numSamples = 100;
