...
public class GLES2CompatUtils {
	...
	public static void glBitmap(int charWidth, int charHeight, float xorig,
			float yorig, float xmove, float ymove, byte[] nonascii, int i) {
		// FIXME STUB
	}
	...
	public static void glLightfv(int glLight0, int glPosition,
			float[] positionZero, int i) {
	...
	public static void glVertexPointer(int dimensions, int glFloat,
			int byteOffset, int pointer) {
		gl2es1.glVertexPointer(dimensions, glFloat, byteOffset, pointer);
	}

	public static void glNormalPointer(int glFloat, int byteOffset,
			int normalOffset) {
	...
	public static void glDrawElements(int geometry, int size,
			int glUnsignedInt, int pointer) {
	...
	public static void glOrtho(float f, float g, float h, float i, float near,
			float far) {
	...
	public static void glViewport(int screenXoffset, int screenYoffset,
			int screenWidth, int screenHeight) {
		gl2es1.glViewport(screenXoffset, screenYoffset, screenWidth,
				screenHeight);
	...
	public static void glMaterialfv(int glFront, int glAmbient, float[] array,
			int i) {
