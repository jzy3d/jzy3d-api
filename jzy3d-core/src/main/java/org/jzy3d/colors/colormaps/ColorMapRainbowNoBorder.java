...
public class ColorMapRainbowNoBorder extends AbstractColorMap implements IColorMap {
  ...
  public Color getColor(double x, double y, double z, double zMin, double zMax) {
    ...
    float b = (float) colorComponentRelativeNoLeftBorder(rel_value, 0.25f, 0.25f, 0.75f);
    float v = (float) colorComponentRelative(rel_value, 0.50f, 0.25f, 0.75f);
    float r = (float) colorComponentRelativeNoRightBorder(rel_value, 0.75f, 0.25f, 0.75f);
