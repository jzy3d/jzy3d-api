...
public class MaskImageSymbolHandler extends SymbolHandler{
    ...
    public MaskImageSymbolHandler(int n) {
        super(n);
        mask = new MaskPair(TextureFactory.get("data/textures/masks/sharp-bg-mask-100-100.png"), TextureFactory.get("data/textures/masks/sharp-symbol-mask-100-100.png"));
