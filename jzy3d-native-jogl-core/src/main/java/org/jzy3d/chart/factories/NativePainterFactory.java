...
public abstract class NativePainterFactory implements IPainterFactory {
	 ...
	 * {@link NativePainterFactory#getDefaultCapabilities(GLProfile)} based on the
	 ...
	 * {@link GLCapabilities#setOnscreen(boolean)} properly and let inheriting
	 * painters they should use {@link OffscreenCanvas} instead of the
	 * {@link ICanvas} they use by default for display.
	 */
	@Override
